...
// $insert = "INSERT INTO user2 (name ,email ,pass ,gend,imag) VALUES
// ('$name','$email','$password','$gender','$imagname')";
...
// }
    $stmt = $connt->prepare("INSERT INTO user2 (name ,email ,pass ,gend,imag)
        VALUES (?, ?, ?, ?,'$imagname' )");
